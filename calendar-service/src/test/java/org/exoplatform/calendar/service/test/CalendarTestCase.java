...
public class CalendarTestCase extends BaseCalendarServiceTestCase {
  ...
  public void testRemoveEventCategory() throws Exception {
    ...
    CalendarEvent publicEvent = createGroupEvent(groupCalendar.getId(), eventCategory, "Have a meeting", fromCal, toCal);
  ...
  public void testCheckFreeBusy() throws Exception {
    ...
    createGroupEvent(publicCalendar.getId(), eventCategory, "Have a meeting", fromCal, toCal);
